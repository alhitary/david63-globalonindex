...
$lang = array_merge($lang, array(
	...
	'ALLOW_EVENTS_EXPLAIN'			=> 'السماح باستخدام الأحداث الخاصة بالقالب في الإعلانات.<br />اختار "لا" في حالة وجود مشكلة أو نتائج غير مرغوبة بسبب أحداث قالب آخر.',
	'ALLOW_GUESTS'					=> 'عرض الإعلانات للزائرين ',
	'ALLOW_GUESTS_EXPLAIN'			=> 'السماح للزائرين من مُشاهدة الإعلانات.',

	'ANNOUNCE_ON_INDEX'				=> 'الإعلانات على الصفحة الرئيسية ',
	'ANNOUNCE_ON_INDEX_ENABLE'		=> 'تفعيل الإعلانات ',
	'ANNOUNCE_ON_INDEX_EXPLAIN' 	=> 'من هنا تستطيع ضبط الخيارات.',
	'ANNOUNCE_ON_INDEX_LOG'			=> '<strong>تم تحديث الإعدادات بنجاح </strong>',
	'ANNOUNCE_ON_INDEX_MANAGE'		=> 'الإعدادات',
